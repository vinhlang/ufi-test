...
public class RegistrationService {
    ...
    public List<RegistrationDto> getReportRegistration(Long classId){
        List<RegistrationDto> registrationDtos = registrationRepository.getReportRegistration(classId);
